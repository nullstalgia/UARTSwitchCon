...
static uint8_t report30[49] = {[0] = 0x30, [1] = 0x0, [2] = 0x86, [12] = 0x08};
...
void send_buttons() {
  ...
  // encode left stick
  report30[6] = (test << 4) & 0xF0;
  report30[7] = (test & 0xF0) >> 4;
  report30[8] = test;
  // encode right stick
  // report30[9] = (lx_send << 4) & 0xF0;
  // report30[10] = (lx_send & 0xF0) >> 4;
  // report30[11] = ly_send;
...
/// Switch Replies
static uint8_t reply02[] = {0x21, 0x05, 0x8E, 0x84, 0x00, 0x12, 0x01,
                            0x18, 0x80, 0x01, 0x18, 0x80, 0x80, 0x82,
                            0x02, 0x03, 0x48, 0x01, 0x02, 0xA2, 0x55,
                            0x79, 0xAB, 0x78, 0xCC, 0x01, 0x01,0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static uint8_t reply08[] = {
    0x21, 0x06, 0x8E, 0x84, 0x00, 0x12, 0x01, 0x18, 0x80, 0x01, 0x18, 0x80, 0x80, 
