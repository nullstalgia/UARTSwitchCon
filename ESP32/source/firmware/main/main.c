...
// 80
static uint8_t report30[49] = {[0] = 0x30, [1] = 0x00, [2] = 0x88, [12] = 0x80};

static uint8_t dummy[12] = {0x30, 0x00, 0x88, 0x00, 0x00, 0x00,
...
static uint8_t reply02[] = {
    ...
    0x00, 0x00, 0x00, 0x82, 0x02, 0x04, 0x09,
    CONTROLLER_TYPE,  // Controller type byte.
    // 01 - Left Joycon
    // 02 - Right Joycon
    // 03 - Pro Controller
    0x02, 0x00, 0x1A, 0x7D, 0xDA, 0x71, 0x13, 0x01,
#if CONTROLLER_TYPE == PRO_CON
    0x02
#else
    0x01
...
static uint8_t spi_reply_address_0[] = {0x21, 0x02, 0x8E,
                                        0x00, 0x00, 0x00,
                                        0x00, 0x08, 0x80,
                                        0x00, 0x00, 0x00,
                                        0x00, 0x90, 0x10,
...
static uint8_t spi_reply_address_0x50[] = {
    0x21, 0x03, 0x8E, 0x00, 0x00, 0x00, 0x00, 0x08, 0x80, 0x00, 0x00,
...
static uint8_t reply3333[] = {
    0x21, 0x31, 0x8e, 0x00, 0x00, 0x00, 0x00, 0x08, 0x80, 0x00,
